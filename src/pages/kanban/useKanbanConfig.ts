  ...
  const loadConfigs = useCallback(async () => {
    try {
      ...
      const padrao: Record<string, any[]> = {
        atendimento: [
          { id: 'lead', title: 'Lead', colorHex: '#64748b' },
          { id: 'contato', title: 'Contato', colorHex: '#2563eb' },
          { id: 'negociacao', title: 'Negociação', colorHex: '#d97706' }
        ],
        vendas: [
          { id: 'pos', title: 'Pós-Vendas', colorHex: '#64748b' },
          { id: 'renovacao', title: 'Renovação do Seguro', colorHex: '#2563eb' },
          { id: 'negociacao_vendas', title: 'Negociação para Clientes', colorHex: '#d97706' }
        ],
        perdas: [
          { id: 'recuperacao', title: 'Recuperação', colorHex: '#64748b' },
          { id: 'contato_perda', title: 'Novo Contato', colorHex: '#2563eb' },
