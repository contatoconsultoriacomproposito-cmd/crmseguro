...
export default function ModeloCotacaoEmpresarial({ propostaId, onClose }: ModeloCotacaoEmpresarialProps) {
  ...
  try {
    ...
    // 2. Busca o cliente de forma isolada para evitar o erro de FK do PostgREST
    let clienteDb = null;
    ...
    // 4. Busca as opções e itens da proposta
    ...
    // 5. Atualiza o estado mantendo a compatibilidade do objeto
    setDadosBase({
      proposta,
      corretora,
      corretor,
  ...
  // Trava de segurança para evitar erro de destructuring caso dadosBase seja null
  if (!dadosBase) {
    return (
      <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
